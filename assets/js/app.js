...
var app = {
    ...
    isRandom: false,
    isRepeat: false,
    config: JSON.parse(localStorage.getItem(USER_DATA_KEY)) || {},
    songs: [
        {
            name: 'Hướng Dương',
            singer: 'Changg',
    ...
    setConfig: function (key, value) {
        ...
        localStorage.setItem(USER_DATA_KEY, JSON.stringify(this.config));
    },
    ...
    start: function () {
        ...
        // Hiển thị trạng thái phiên trước
